...
func _ready()->void:
	...
	specimen=SucculentClass.new();specimen.name="Specimen";add_child(specimen);var sample={"species_id":"laui","name_ja":"ラウイ","rarity":"レア","spawn_weight":1.0,"base_growth_rate":1.0,"jelly_risk_curve":0.0,"visual_variant":"laui","golden_variant":true,"colors":["9fb5ad","d99aa1"]};specimen.setup(sample,8813,null,null);specimen.age=7.0;specimen.diameter_cm=16.0;specimen.max_life_hint=100000.0
