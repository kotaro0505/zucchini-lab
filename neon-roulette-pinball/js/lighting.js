export class LightingController{
 ...
 reset(){this.energy=.06;this.pulse=0;this.roulette=0;this.combo=0;this.reward=0;this.bumpers=new Set;this.targets=new Set;this.lanes=new Set}
 update(dt){this.pulse=Math.max(0,this.pulse-dt*2.8);this.roulette=Math.max(0,this.roulette-dt*.32);this.combo=Math.max(0,this.combo-dt*.5);this.reward=Math.max(0,this.reward-dt*.8)}
 ...
 snapshot(){return{energy:this.energy,stage:this.stage,pulse:this.pulse,roulette:this.roulette,combo:this.combo,reward:this.reward}}
}
