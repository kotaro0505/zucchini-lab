...
const assets={jeep:image('assets/images/jeep/safari-jeep.png'),background:image('assets/images/background/mexican-trail-wide.png'),atlas:image('assets/images/succulents/specimen-atlas.png')};
